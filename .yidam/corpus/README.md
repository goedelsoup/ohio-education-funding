...
|---|--:|---|
| `[verified]` | 1824 | supported by a committed primary source |
| `[inference]` | 367 | drawn from verified facts, not witnessed |
| `[open]` | 204 | a live question — unknown, contested, or being worked |
| `[unentered]` | 0 | a knowable value nobody has typed in yet |

204 unresolved marks, and every one of them is a live question. The fourth mark is gone from the prose: a field nobody has filled in is carried as `unfilled:` structure on the node it belongs to, which is what `[unentered]` used to say inline on an axis it did not belong to.
...
| [`fsfp-base-cost-calculation`](formula-component/fsfp-base-cost-calculation.yml) | formula-component | FSFP Base Cost Calculation | 13 | 11 |
...
| [`fsfp-community-school-equity-supplement`](formula-component/fsfp-community-school-equity-supplement.yml) | formula-component | FSFP Community School Equity Supplement | 5 | 2 |
...
| [`local-capacity-percentage`](parameter/local-capacity-percentage.yml) | parameter | Local Capacity Percentage | 5 | 4 |
| [`local-share-charge-off-millage`](parameter/local-share-charge-off-millage.yml) | parameter | Local Share Charge-Off Millage | 8 | 9 |
