...
|---|--:|---|
| `[verified]` | 827 | supported by a committed primary source |
...
226 unresolved marks in total, 191 of them live questions and 35 of them empty fields. Before the two were distinguished the corpus reported the sum as its count of what it does not know, which overstated it by 15%.
