...
| [`crates/`](crates/) | The domain computer: 12 Rust crates, 702 test functions, no crates.io dependencies |
...
-->
806 `[verified]`, 229 `[inference]`, 189 `[open]`, 34 `[unentered]`.
<!-- /REGEN -->
