...
| [`.yidam/catalog/`](.yidam/catalog/) | 40 source records. Every numeric claim in the corpus should reach one in a single hop |
| [`.yidam/decisions/`](.yidam/decisions/) | 27 records of why the repository is shaped the way it is, including the ones that turned out wrong |
| [`crates/`](crates/) | The domain computer: 12 Rust crates, 774 test functions, no crates.io dependencies |
...
-->
863 `[verified]`, 240 `[inference]`, 189 `[open]`, 39 `[unentered]`.
<!-- /REGEN -->
