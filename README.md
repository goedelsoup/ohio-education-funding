...
|---|---|
| [`.yidam/corpus/`](.yidam/corpus/) | The knowledge graph: 131 nodes across 18 classes — regimes, components, parameters, litigation, doctrine, exemplar districts |
| [`.yidam/catalog/`](.yidam/catalog/) | 48 source records. Every numeric claim in the corpus should reach one in a single hop |
| [`.yidam/decisions/`](.yidam/decisions/) | 46 records of why the repository is shaped the way it is, including the ones that turned out wrong |
| [`crates/`](crates/) | The domain computer: 13 Rust crates, 1441 test functions, no crates.io dependencies |
...
-->
1650 `[verified]`, 341 `[inference]`, 206 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
