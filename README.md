...
| [`.yidam/catalog/`](.yidam/catalog/) | 56 source records. Every numeric claim in the corpus should reach one in a single hop |
| [`.yidam/decisions/`](.yidam/decisions/) | 56 records of why the repository is shaped the way it is, including the ones that turned out wrong |
| [`crates/`](crates/) | The domain computer: 13 Rust crates, 1902 test functions, no crates.io dependencies |
...
-->
1908 `[verified]`, 383 `[inference]`, 209 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
