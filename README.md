...
| [`.yidam/catalog/`](.yidam/catalog/) | 38 source records. Every numeric claim in the corpus should reach one in a single hop |
| [`.yidam/decisions/`](.yidam/decisions/) | 20 records of why the repository is shaped the way it is, including the ones that turned out wrong |
| [`crates/`](crates/) | The domain computer: 12 Rust crates, 737 test functions, no crates.io dependencies |
...
-->
812 `[verified]`, 230 `[inference]`, 190 `[open]`, 34 `[unentered]`.
<!-- /REGEN -->
