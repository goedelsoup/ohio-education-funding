...
| [`.yidam/decisions/`](.yidam/decisions/) | 36 records of why the repository is shaped the way it is, including the ones that turned out wrong |
| [`crates/`](crates/) | The domain computer: 13 Rust crates, 932 test functions, no crates.io dependencies |
...
-->
1176 `[verified]`, 275 `[inference]`, 216 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
