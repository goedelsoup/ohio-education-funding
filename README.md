...
| [`.yidam/decisions/`](.yidam/decisions/) | 24 records of why the repository is shaped the way it is, including the ones that turned out wrong |
...
-->
818 `[verified]`, 234 `[inference]`, 188 `[open]`, 34 `[unentered]`.
<!-- /REGEN -->
