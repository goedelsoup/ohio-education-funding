...
<!-- REGEN: yidam repository-overview
Regenerated by: `edfund-connect index`
Fields: one row per directory; every count derived from the directory itself.
-->
| Directory | What it holds |
|---|---|
| [`.yidam/corpus/`](.yidam/corpus/) | The knowledge graph: 112 nodes across 18 classes — regimes, components, parameters, litigation, doctrine, exemplar districts |
| [`.yidam/catalog/`](.yidam/catalog/) | 41 source records. Every numeric claim in the corpus should reach one in a single hop |
| [`.yidam/decisions/`](.yidam/decisions/) | 28 records of why the repository is shaped the way it is, including the ones that turned out wrong |
| [`crates/`](crates/) | The domain computer: 12 Rust crates, 798 test functions, no crates.io dependencies |
...
-->
915 `[verified]`, 245 `[inference]`, 206 `[open]`, 38 `[unentered]`.
<!-- /REGEN -->
