...
| [`.yidam/catalog/`](.yidam/catalog/) | 53 source records. Every numeric claim in the corpus should reach one in a single hop |
| [`.yidam/decisions/`](.yidam/decisions/) | 53 records of why the repository is shaped the way it is, including the ones that turned out wrong |
| [`crates/`](crates/) | The domain computer: 13 Rust crates, 1798 test functions, no crates.io dependencies |
...
-->
1857 `[verified]`, 378 `[inference]`, 203 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
