...
| [`.yidam/decisions/`](.yidam/decisions/) | 29 records of why the repository is shaped the way it is, including the ones that turned out wrong |
| [`crates/`](crates/) | The domain computer: 12 Rust crates, 810 test functions, no crates.io dependencies |
...
-->
982 `[verified]`, 251 `[inference]`, 206 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
