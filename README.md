...
| [`.yidam/catalog/`](.yidam/catalog/) | 36 source records. Every numeric claim in the corpus should reach one in a single hop |
...
| [`crates/`](crates/) | The domain computer: 12 Rust crates, 686 test functions, no crates.io dependencies |
...
-->
802 `[verified]`, 229 `[inference]`, 188 `[open]`, 34 `[unentered]`.
<!-- /REGEN -->
