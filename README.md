...
| [`crates/`](crates/) | The domain computer: 13 Rust crates, 1375 test functions, no crates.io dependencies |
...
-->
1588 `[verified]`, 325 `[inference]`, 197 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
