...
| [`.yidam/catalog/`](.yidam/catalog/) | 44 source records. Every numeric claim in the corpus should reach one in a single hop |
| [`.yidam/decisions/`](.yidam/decisions/) | 39 records of why the repository is shaped the way it is, including the ones that turned out wrong |
| [`crates/`](crates/) | The domain computer: 13 Rust crates, 943 test functions, no crates.io dependencies |
...
-->
1181 `[verified]`, 277 `[inference]`, 217 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
