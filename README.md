...
| [`.yidam/decisions/`](.yidam/decisions/) | 52 records of why the repository is shaped the way it is, including the ones that turned out wrong |
| [`crates/`](crates/) | The domain computer: 13 Rust crates, 1758 test functions, no crates.io dependencies |
...
-->
1850 `[verified]`, 378 `[inference]`, 203 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
