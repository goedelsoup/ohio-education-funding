...
| [`.yidam/decisions/`](.yidam/decisions/) | 19 records of why the repository is shaped the way it is, including the ones that turned out wrong |
| [`crates/`](crates/) | The domain computer: 12 Rust crates, 731 test functions, no crates.io dependencies |
...
-->
810 `[verified]`, 230 `[inference]`, 189 `[open]`, 34 `[unentered]`.
<!-- /REGEN -->
