...
| [`.yidam/catalog/`](.yidam/catalog/) | 54 source records. Every numeric claim in the corpus should reach one in a single hop |
...
| [`crates/`](crates/) | The domain computer: 13 Rust crates, 1833 test functions, no crates.io dependencies |
...
-->
1865 `[verified]`, 384 `[inference]`, 203 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
