...
|---|---|
| [`.yidam/corpus/`](.yidam/corpus/) | The knowledge graph: 106 nodes across 18 classes — regimes, components, parameters, litigation, doctrine, exemplar districts |
...
-->
870 `[verified]`, 240 `[inference]`, 190 `[open]`, 38 `[unentered]`.
<!-- /REGEN -->
