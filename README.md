...
| [`.yidam/decisions/`](.yidam/decisions/) | 45 records of why the repository is shaped the way it is, including the ones that turned out wrong |
| [`crates/`](crates/) | The domain computer: 13 Rust crates, 1041 test functions, no crates.io dependencies |
...
-->
1273 `[verified]`, 289 `[inference]`, 210 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
