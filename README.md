...
| [`crates/`](crates/) | The domain computer: 13 Rust crates, 1456 test functions, no crates.io dependencies |
...
-->
1657 `[verified]`, 341 `[inference]`, 205 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
