...
| [`.yidam/catalog/`](.yidam/catalog/) | 34 source records. Every numeric claim in the corpus should reach one in a single hop |
...
| [`crates/`](crates/) | The domain computer: 12 Rust crates, 663 test functions, no crates.io dependencies |
...
-->
557 `[verified]`, 210 `[inference]`, 175 `[open]`, 38 `[unentered]`.
<!-- /REGEN -->
