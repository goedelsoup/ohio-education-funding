...
|---|---|
| [`.yidam/corpus/`](.yidam/corpus/) | The knowledge graph: 133 nodes across 18 classes — regimes, components, parameters, litigation, doctrine, exemplar districts |
| [`.yidam/catalog/`](.yidam/catalog/) | 55 source records. Every numeric claim in the corpus should reach one in a single hop |
| [`.yidam/decisions/`](.yidam/decisions/) | 55 records of why the repository is shaped the way it is, including the ones that turned out wrong |
| [`crates/`](crates/) | The domain computer: 13 Rust crates, 1841 test functions, no crates.io dependencies |
...
-->
1868 `[verified]`, 384 `[inference]`, 203 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
