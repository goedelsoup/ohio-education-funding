...
| [`crates/`](crates/) | The domain computer: 12 Rust crates, 674 test functions, no crates.io dependencies |
...
-->
559 `[verified]`, 210 `[inference]`, 176 `[open]`, 34 `[unentered]`.
<!-- /REGEN -->
