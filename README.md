...
| [`crates/`](crates/) | The domain computer: 13 Rust crates, 1865 test functions, no crates.io dependencies |
...
-->
1896 `[verified]`, 384 `[inference]`, 207 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
