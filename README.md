...
| [`.yidam/catalog/`](.yidam/catalog/) | 57 source records. Every numeric claim in the corpus should reach one in a single hop |
| [`.yidam/decisions/`](.yidam/decisions/) | 57 records of why the repository is shaped the way it is, including the ones that turned out wrong |
| [`crates/`](crates/) | The domain computer: 13 Rust crates, 1958 test functions, no crates.io dependencies |
...
-->
1948 `[verified]`, 384 `[inference]`, 214 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
