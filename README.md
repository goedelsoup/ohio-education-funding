...
| [`.yidam/catalog/`](.yidam/catalog/) | 59 source records. Every numeric claim in the corpus should reach one in a single hop |
...
| [`crates/`](crates/) | The domain computer: 13 Rust crates, 1976 test functions, no crates.io dependencies |
...
-->
1962 `[verified]`, 384 `[inference]`, 211 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
