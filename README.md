...
| [`.yidam/catalog/`](.yidam/catalog/) | 51 source records. Every numeric claim in the corpus should reach one in a single hop |
...
| [`crates/`](crates/) | The domain computer: 13 Rust crates, 1657 test functions, no crates.io dependencies |
...
-->
1781 `[verified]`, 358 `[inference]`, 207 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
