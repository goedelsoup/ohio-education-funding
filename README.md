...
|---|---|
| [`.yidam/corpus/`](.yidam/corpus/) | The knowledge graph: 98 nodes across 17 classes — regimes, components, parameters, litigation, doctrine, exemplar districts |
| [`.yidam/catalog/`](.yidam/catalog/) | 35 source records. Every numeric claim in the corpus should reach one in a single hop |
| [`.yidam/decisions/`](.yidam/decisions/) | 16 records of why the repository is shaped the way it is, including the ones that turned out wrong |
| [`crates/`](crates/) | The domain computer: 12 Rust crates, 681 test functions, no crates.io dependencies |
...
-->
754 `[verified]`, 222 `[inference]`, 178 `[open]`, 34 `[unentered]`.
<!-- /REGEN -->
