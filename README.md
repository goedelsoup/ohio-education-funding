...
| [`.yidam/decisions/`](.yidam/decisions/) | 54 records of why the repository is shaped the way it is, including the ones that turned out wrong |
| [`crates/`](crates/) | The domain computer: 13 Rust crates, 1809 test functions, no crates.io dependencies |
...
-->
1861 `[verified]`, 383 `[inference]`, 203 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
