...
| [`.yidam/catalog/`](.yidam/catalog/) | 50 source records. Every numeric claim in the corpus should reach one in a single hop |
| [`.yidam/decisions/`](.yidam/decisions/) | 48 records of why the repository is shaped the way it is, including the ones that turned out wrong |
| [`crates/`](crates/) | The domain computer: 13 Rust crates, 1607 test functions, no crates.io dependencies |
...
-->
1745 `[verified]`, 353 `[inference]`, 207 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
