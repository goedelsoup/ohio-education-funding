...
| [`crates/`](crates/) | The domain computer: 13 Rust crates, 959 test functions, no crates.io dependencies |
...
-->
1190 `[verified]`, 278 `[inference]`, 217 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
