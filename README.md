...
| [`crates/`](crates/) | The domain computer: 13 Rust crates, 1855 test functions, no crates.io dependencies |
...
-->
1893 `[verified]`, 384 `[inference]`, 208 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
