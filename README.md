...
|---|---|
| [`.yidam/corpus/`](.yidam/corpus/) | The knowledge graph: 110 nodes across 18 classes — regimes, components, parameters, litigation, doctrine, exemplar districts |
...
-->
901 `[verified]`, 241 `[inference]`, 200 `[open]`, 38 `[unentered]`.
<!-- /REGEN -->
