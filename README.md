...
| [`.yidam/catalog/`](.yidam/catalog/) | 49 source records. Every numeric claim in the corpus should reach one in a single hop |
| [`.yidam/decisions/`](.yidam/decisions/) | 47 records of why the repository is shaped the way it is, including the ones that turned out wrong |
| [`crates/`](crates/) | The domain computer: 13 Rust crates, 1468 test functions, no crates.io dependencies |
...
-->
1676 `[verified]`, 344 `[inference]`, 205 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
