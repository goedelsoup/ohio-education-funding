...
| [`.yidam/decisions/`](.yidam/decisions/) | 25 records of why the repository is shaped the way it is, including the ones that turned out wrong |
| [`crates/`](crates/) | The domain computer: 12 Rust crates, 748 test functions, no crates.io dependencies |
