...
| [`.yidam/decisions/`](.yidam/decisions/) | 51 records of why the repository is shaped the way it is, including the ones that turned out wrong |
| [`crates/`](crates/) | The domain computer: 13 Rust crates, 1714 test functions, no crates.io dependencies |
...
-->
1821 `[verified]`, 366 `[inference]`, 205 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
