...
|---|---|
| [`.yidam/corpus/`](.yidam/corpus/) | The knowledge graph: 132 nodes across 18 classes — regimes, components, parameters, litigation, doctrine, exemplar districts |
| [`.yidam/catalog/`](.yidam/catalog/) | 52 source records. Every numeric claim in the corpus should reach one in a single hop |
| [`.yidam/decisions/`](.yidam/decisions/) | 50 records of why the repository is shaped the way it is, including the ones that turned out wrong |
| [`crates/`](crates/) | The domain computer: 13 Rust crates, 1678 test functions, no crates.io dependencies |
...
-->
1791 `[verified]`, 360 `[inference]`, 207 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
