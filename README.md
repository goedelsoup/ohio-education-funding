...
| [`.yidam/decisions/`](.yidam/decisions/) | 43 records of why the repository is shaped the way it is, including the ones that turned out wrong |
...
-->
1212 `[verified]`, 279 `[inference]`, 215 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
