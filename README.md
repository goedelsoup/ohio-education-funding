...
| [`.yidam/decisions/`](.yidam/decisions/) | 44 records of why the repository is shaped the way it is, including the ones that turned out wrong |
| [`crates/`](crates/) | The domain computer: 13 Rust crates, 1008 test functions, no crates.io dependencies |
...
-->
1217 `[verified]`, 279 `[inference]`, 216 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
