...
| [`.yidam/catalog/`](.yidam/catalog/) | 45 source records. Every numeric claim in the corpus should reach one in a single hop |
| [`.yidam/decisions/`](.yidam/decisions/) | 41 records of why the repository is shaped the way it is, including the ones that turned out wrong |
| [`crates/`](crates/) | The domain computer: 13 Rust crates, 962 test functions, no crates.io dependencies |
...
-->
1200 `[verified]`, 277 `[inference]`, 216 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
