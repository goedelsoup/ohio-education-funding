...
| [`.yidam/decisions/`](.yidam/decisions/) | 23 records of why the repository is shaped the way it is, including the ones that turned out wrong |
| [`crates/`](crates/) | The domain computer: 12 Rust crates, 747 test functions, no crates.io dependencies |
...
-->
813 `[verified]`, 231 `[inference]`, 190 `[open]`, 34 `[unentered]`.
<!-- /REGEN -->
