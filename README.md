...
| [`.yidam/decisions/`](.yidam/decisions/) | 40 records of why the repository is shaped the way it is, including the ones that turned out wrong |
...
-->
1189 `[verified]`, 278 `[inference]`, 217 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
