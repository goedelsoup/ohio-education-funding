...
| [`.yidam/catalog/`](.yidam/catalog/) | 46 source records. Every numeric claim in the corpus should reach one in a single hop |
| [`.yidam/decisions/`](.yidam/decisions/) | 42 records of why the repository is shaped the way it is, including the ones that turned out wrong |
| [`crates/`](crates/) | The domain computer: 13 Rust crates, 982 test functions, no crates.io dependencies |
...
-->
1209 `[verified]`, 279 `[inference]`, 216 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
