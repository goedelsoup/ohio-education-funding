...
| [`.yidam/decisions/`](.yidam/decisions/) | 49 records of why the repository is shaped the way it is, including the ones that turned out wrong |
| [`crates/`](crates/) | The domain computer: 13 Rust crates, 1617 test functions, no crates.io dependencies |
...
-->
1749 `[verified]`, 353 `[inference]`, 207 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
