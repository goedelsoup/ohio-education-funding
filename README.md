...
| [`crates/`](crates/) | The domain computer: 13 Rust crates, 1421 test functions, no crates.io dependencies |
...
-->
1647 `[verified]`, 340 `[inference]`, 206 `[open]`, 0 `[unentered]`.
<!-- /REGEN -->
