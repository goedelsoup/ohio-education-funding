...
| [`project`](project/) | Forward projection of funding inputs, and policy simulation over them | 83 |
| [`spreadsheet`](spreadsheet/) | Read the department's published workbooks with no dependencies | 70 |

10 crates, 406 test functions, no crates.io dependencies. `cargo test` reports a different total: it adds doc-tests and counts each integration binary separately.
<!-- /REGEN -->
