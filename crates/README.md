...
| [`connect`](connect/) | Retrieval and extraction: the department's publications into committed fixtures | 239 |
...
| [`project`](project/) | Forward projection of funding inputs, and policy simulation over them | 918 |
...
13 crates, 1997 test functions, no crates.io dependencies. `cargo test` reports a different total: it adds doc-tests and counts each integration binary separately.
<!-- /REGEN -->
