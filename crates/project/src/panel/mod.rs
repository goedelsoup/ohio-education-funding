...
pub use categoricals::{
    ...
    TA_MEDIAN_WEIGHTED_WEALTH, TA_SUPPLEMENT_FLOOR_SHARE, TA_SUPPLEMENT_INDEX_THRESHOLD,
    TA_SUPPLEMENT_RETENTION, TA_SUPPLEMENT_TOP_RATE, TA_WEALTH_BLEND, TA_WEALTH_INDEX_FLOOR,
