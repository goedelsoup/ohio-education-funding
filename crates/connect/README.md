...
- `lsc-budget` — still blocked on: wired for the appropriation-line series FY1999 through FY2027, from the 124th General Assembly's greenbook to the 136th's workbooks. Two bienniums are missing an enacted figure and neither is retrievable: FY2006-07, because the 126th's greenbook has no line-item table at all, and FY2012-13, because LSC serves that biennium's two workbook variants as the same file. Before FY1999 there is nothing — the Foundation Program era, DeRolph I and the equal yield formula still need the session laws. The Catalog of Budget Line Items and the per-district simulations have an index page each and have not been opened
