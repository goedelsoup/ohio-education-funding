...
pub use paths::{
    ...
    LANDSCAPE_FIXTURE, LSC_GREENBOOK_FIXTURE, MR81_FIXTURE, NOT_REGENERATED, OPINIONS_FIXTURE,
    ...
    SESSION_LAW_FIXTURE, SFPR_FIXTURE, STATUTE_FIXTURE, TITLE1_FIXTURE, TRANSFER_FIXTURE,
    TRANSPORT_RATES_FIXTURE, TYPOLOGY_FIXTURE,
};
