...
pub use paths::{
    ...
    CPI_FIXTURE, CROSSWALK_FIXTURE, DIESEL_FIXTURE, EDCHOICE_DESIGNATED_FIXTURE, EDCHOICE_FIXTURE,
    ENACTED_FIXTURE, F33_DISTRICTS_FIXTURE, F33_FIXTURE, F33_FY2024_FIXTURE,
    F33_OHIO_PANEL_FIXTURE, FINANCE_FIXTURE, FUNCTIONS_FIXTURE, FY25_FIXTURE, FY26_FIXTURE,
    FY27_FIXTURE, GRADE_BANDS_FIXTURE, GREENBOOK_FIXTURE, IDENTIFIED_FIXTURE, JVSD_FUNDING_FIXTURE,
