...
pub use paths::{
    APPROPRIATION_FIXTURE, BUILDING_FIXTURE, CALCULATOR_SCALARS_FIXTURE, CASINO_FIXTURE,
    CATALOG_BASIS_FIXTURE, CATALOG_FIXTURE, CCD_DIRECTORY_FIXTURE, CORRECTIONS_FIXTURE,
    CPI_FIXTURE, CROSSWALK_FIXTURE, DIESEL_FIXTURE, EDCHOICE_FIXTURE, ENACTED_FIXTURE,
